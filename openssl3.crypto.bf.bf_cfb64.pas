unit openssl3.crypto.bf.bf_cfb64;
...
uses OpenSSL.Api;
 ...
 procedure BF_cfb64_encrypt({const} _in : PByte; _out : PByte; length : long;const schedule : PBF_KEY; ivec : PByte; num : PInteger; encrypt : integer);
